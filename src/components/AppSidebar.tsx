...
const menuItems = [
  ...
  { title: "CRM Leads", url: "/crm-leads", icon: Users, description: "Gestão inteligente de leads extraídos" },
  {
    ...
    icon: BarChart3,
    description: "Analise o desempenho do chat",
  },
  {
        ...
        <div className="flex items-center justify-center h-12 md:h-16">
          {!collapsed ? (
            <div className="flex items-center gap-3">
              ...
              <img src={logoLightUrl} alt={companyName} className="h-16 w-auto dark:hidden md:h-20" />
              {/* Logo para modo escuro */}
              <img src={logoDarkUrl} alt={companyName} className="h-16 w-auto hidden dark:block md:h-20" />
            </div>
          ) : (
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center shadow-glow">
              <img src={logoIconUrl} alt={companyName} className="w-8 h-8" />
            </div>
          )}
        </div>
      </SidebarHeader>
                ...
                <SidebarMenuButton asChild className="h-10 group">
                  ...
                  >
                    <div className={`flex items-center ${collapsed ? "" : "gap-3"}`}>
                      ...
                      {!collapsed && <span className="text-sm font-medium">Link WhatsApp</span>}
                    </div>
                  </NavLink>
                </SidebarMenuButton>
              </SidebarMenuItem>
