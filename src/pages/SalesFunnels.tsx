          ...
          {canManage && (
            <Card>
              ...
              <CardContent className="grid gap-4 md:grid-cols-2">
                ...
                {assetType === 'text' ? (
                  <div className="space-y-2 md:col-span-2"><Label>Texto</Label><Textarea className="min-h-40 font-sans" value={assetContent} onChange={(e) => setAssetContent(e.target.value)} placeholder="Use {nome} e {telefone} para personalizar." /><p className="text-xs text-muted-foreground">As quebras de linha, emojis, links e marcações como *negrito*, _itálico_ e ~tachado~ serão enviadas como você escreveu.</p></div>
                ) : (
                  <>
