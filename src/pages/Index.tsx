...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background/50">
      ...
      {/* Demo Section */}
      <section className="container mx-auto px-4 py-20 bg-gradient-to-br from-primary/5 to-transparent">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Como é Simples Usar o CLONEFY</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-primary/10 text-primary rounded-full px-4 py-2 text-sm font-medium inline-block mb-4">
              Passo 1
            </div>
            <h3 className="text-2xl font-bold mb-4">Criar Seu Agente</h3>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span>Interface clean e fácil de usar</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
          ...
          <div className="order-1 lg:order-2">
            <img 
              ...
              className="rounded-2xl shadow-2xl border w-full max-w-md mx-auto"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-4">Personalizar Completamente</h3>
            <p className="text-muted-foreground text-lg mb-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Personalize o nome e função</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Configure instruções específicas</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Adicione arquivos e conhecimento</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h3 className="text-2xl font-bold mb-4">Gerenciar Seus Agentes</h3>
            <p className="text-muted-foreground text-lg mb-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Dashboard organizado e claro</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Botões de ação rápida</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Teste antes de colocar no ar</span>
              </li>
            </ul>
          </div>
          <div className="order-1 lg:order-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-4">Conectar ao WhatsApp</h3>
            <p className="text-muted-foreground text-lg mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h3 className="text-2xl font-bold mb-4">Incorporar no Seu Site</h3>
            <p className="text-muted-foreground text-lg mb-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Código pronto para copiar</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Widget responsivo</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-primary"></div>
                <span>Integração em qualquer site</span>
              </li>
            </ul>
          </div>
          <div className="order-1 lg:order-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-4">Agente Funcionando Perfeitamente!</h3>
            <p className="text-muted-foreground text-lg mb-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span>Conversas naturais e fluidas</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span>Respostas contextualizadas</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span>Disponível 24/7 sem pausas</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-3xl p-8 max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold mb-4">É Assim de Simples!</h3>
            ...
            <Link to="/auth">
              <Button size="lg" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 px-8 py-4">
                Criar Meu Primeiro Agente Agora
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>
