                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-6">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-3">
                            Veja como funciona na <span className="text-emerald-600">prática</span>
                        </h2>
                    </div>
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-emerald-200 bg-slate-900">
                        <div className="aspect-video">
                            <iframe
                                width="100%"
                                height="100%"
                                src="https://www.youtube.com/embed/944439PK88k"
                                title="v1 clonefy afiliado ok"
                                frameBorder="0"
